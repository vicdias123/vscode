...
const projects = [
  {
    ...
    brand: "Cliente Previdenciário",
    description: "Representamos com sucesso a revisão de benefício previdenciário junto ao INSS, garantindo aumento significativo do valor mensal.",
    tags: ["Previdenciário", "Revisão", "INSS"],
    imageUrl: "/IMG/08_direito_civil.webp",
    link: "/projects/revisao-aposentadoria",
    details: `Conduzimos análise de documentos, interpus recursos administrativos, e obtivemos resultado favorável em revisão de aposentadoria, garantindo ao cliente acréscimo de benefício e correção de valores.`
  },
  {
    id: 2,
    title: "Ação de Responsabilidade Civil",
    brand: "Cliente Empresarial",
    description: "Defendemos caso de responsabilidade civil por descumprimento contratual, resultando em indenização para nosso cliente.",
    tags: ["Civil", "Contratos", "Responsabilidade"],
    imageUrl: "/IMG/09_direito_comercial.webp",
    link: "/projects/acao-responsabilidade-civil"
  },
  {
    id: 3,
    title: "Defesa Criminal Estratégica",
    brand: "Cliente Criminal",
    description: "Prestamos defesa técnica em processo penal complexo, assegurando direitos fundamentais e absolvição.",
    tags: ["Criminal", "Defesa", "Litígio"],
    imageUrl: "/IMG/03_direito_penal.png",
    link: "/projects/defesa-criminal"
  }
];
      ...
      <div className="w-full px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <div className={`text-center mb-10 max-w-3xl mx-auto transition-all duration-1000 ${isInView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          ...
          <h2 className="text-3xl font-bold mb-3">
            De Desafios Jurídicos a Soluções
          </h2>
          <p className="text-gray-600">
            Descubra como nossas estratégias jurídicas resultaram em resultados extraordinários para nossos clientes em diversos casos.
          </p>
          {isMobile && (
